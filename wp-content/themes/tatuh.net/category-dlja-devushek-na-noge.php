...
<p>Летом на загорелом теле, зимой под прозрачными чулками татуировка на изящной ножке выглядит очень стильно. Особенно, если сделана хорошим мастером. Тату подчёркивают форму ноги, добавляют элегантности и рождают неповторимый образ.
<br>
<br>
Если ноги ухоженные, подтянутые, то татуировка подойдёт и юной девушке, и даме за 40.</p>
</div>
</article>
<?php if ( have_posts() ) : ?>
